					...
					$.each(result.content,function(idx, noticeVO){
						str += `<tr>
					          ...
					          <th scope='row' style="text-align:left">
					            <a href='/cbs/admin/noticeDetail?noticeNo=\${noticeVO.noticeNo}' class='detBtn' data-notice-titl='\${noticeVO.titl}'>
							       \${noticeVO.titl}
							   </a>
					          </th>
					          <td>관리자</td>
...
<div class="card h-50">
	<div class="card-body">
		...
		<!-- ///검색 시작 /// -->
            ...
            <button class="btn btn-primary btn-sm w-10" type="button" id="btnSearch">검색</button>&emsp;
			</div>	
		<!-- ///검색 끝 /// -->
		...
		<a type="button" href="/cbs/admin/noticeCreated" class="btn btn-primary px-2 px-sm-2" type="button" id="btnInsert" style="position: relative; width: 200px; left: 85%;">등록</a>
		</div>
	</div>
</div>
</div>
