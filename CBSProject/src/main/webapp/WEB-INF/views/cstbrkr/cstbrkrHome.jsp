...
<script type="text/javascript" src="/resources/js/list.min.js"></script>
<link rel="stylesheet"
...
<body>
	<div class="card h-50">
		<div
			style="text-align: center; margin =0; max-width: 100%; height: auto;">
			<!-- 이미지를 중앙으로 정렬하기 위해 추가 -->
			<img id="ims" src="/resources/img/진행0.png">
		</div>
		<div class="card-body">
			<div class="px-3 mb-5">
