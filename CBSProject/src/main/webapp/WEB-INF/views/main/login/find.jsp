...
<style>
.main {
	background: url('/resources/img/로그인UA.gif');
		...
		<main class="main" id="top">
			<div class="container">
				<div class="row flex-center min-vh-100 py-5">
					<div class="card border border-translucent auth-card" style=" width: 600;">
