...
window.onload = function(){
   ...
   $.ajax ({
        ...
        success: function(result) {
         ...
         // ################### 처리 상태에 따라 버튼 처리 ###################
         if(result.processSttus == "EPS2") {
            $("#changeTextBtn2").text("운송(입고) 신청").attr("id","eps2Btn").show();
         } 
         else if(result.processSttus == "EPS4") {
         ...
         else if(result.processSttus == "EPS7") {
...
// 			});
         ...
         else if(result.processSttus == "EPS8") {
            $("#changeTextBtn2").text("운송(출고) 신청").attr("id","eps8Btn").show()
         } 
         else if(result.processSttus == "EPS11") {
...
//                                     console.log("result.bndwasNo~~: " +result.bndwasNo);
                              ...
                              Swal.fire({
                                title: "창고 자동 배정",
                                html: "임시 보세창고의 구역을<b></b> 자동 배정 중입니다.",
                                timer: 3000,
