...
<style>
.main {
	background-image: url('/resources/img/로그인UA.gif');
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
        <div class="bg-holder" style="background-image:url('/resources/img/로그인UA.gif');"></div>
        <!--/.bg-holder-->
    ...
    function prod1() {
    	new daum.Postcode({
			oncomplete: function(data) {
				...
				$('[id=adres]').val(data.buildingName);
			}
		}).open();
    }
</script>
